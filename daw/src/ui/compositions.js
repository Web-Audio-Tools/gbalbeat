...
window.UIcompositionClickSave = UIcompositionClickSave;

window.UIcompositionClickNewLocal = UIcompositionClickNewLocal;

window.UIcompositionsInit = UIcompositionsInit;

window.UIcompositionBeforeUnload = UIcompositionBeforeUnload;

window.UIcompositionAdded = UIcompositionAdded;

window.UIcompositionOpened = UIcompositionOpened;

window.UIcompositionClosed = UIcompositionClosed;

window.UIcompositionDeleted = UIcompositionDeleted;
